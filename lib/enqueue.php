...
function theme_scripts() {
  ...
  wp_enqueue_script('theme-js', get_stylesheet_directory_uri() . '/assets/dist/js/theme.js', array('jquery'), true);

  wp_enqueue_style( 'theme-css', get_stylesheet_directory_uri() . '/assets/dist/css/theme.css', array(), null );
