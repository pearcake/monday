...
function theme_scripts() {
  ...
  if (!wp_is_mobile && preg_match('~MSIE|Internet Explorer~i', $_SERVER['HTTP_USER_AGENT']) || (strpos($_SERVER['HTTP_USER_AGENT'], 'Trident/7.0; rv:11.0') !== false)) {
    ...
    wp_enqueue_script('theme-js', get_stylesheet_directory_uri() . '/assets/dist/js/theme-ie.js', array('jquery'), filemtime( get_theme_file_path('assets/dist/js/theme-ie.js') ), true);
  } else {
